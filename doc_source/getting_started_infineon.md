...
1. Unzip the downloaded file to a folder, and make note of the folder path\. The unzipped folder is called `AmazonFreeRTOS`\.
...
1. In the **Import DAVE Projects** window, choose **Select Root Directory**, choose **Browse**, and then choose the XMC4800 demo project\.
   ...
   In the directory where you unzipped your Amazon FreeRTOS download, the demo project is located in `demos/infineon/xmc4800_iotkit/dave`\.   
